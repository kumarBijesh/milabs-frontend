...
import { Users, Building2, Calendar, CreditCard, Megaphone, TrendingUp, AlertCircle, MessageSquare, Activity } from 'lucide-react';
...
export default function AdminDashboardPage() {
    ...
    const renderDashboard = () => {
        switch (role) {
            ...
            default:
                // General Admin / Super Admin Default View
                return (
                    <div className="space-y-8 animate-fade-in">
                        <div>
